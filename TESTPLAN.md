...
| 54.2 | Tap a card that is **not** the last | No stepper: the slot of the **Next time** block shows one line — **"set 2 · the clock saw 6 s"** — and an **OK** that hands the slot back. The set ended on the clock, so there is nothing to enter (owner, 13.09.2026; before that the panel opened with "+" dead at the clock and read as broken) |
