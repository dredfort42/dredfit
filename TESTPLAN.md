...
| 54.5 | The block **Next time**, standing directly above **Done** — the same distance the entry panel keeps | One sentence naming the plan the app will set — "The app will set 30-30-25 sec — from what was held." when a number differs from the plan, "… if you rate the workout “on plan”." when none does — and a stepper reading **+0 s** |
