...
Three layers, 642 automated tests: 70 core + 500 app units + 72 UI tests, all confirmed green on this wave's run (`** TEST SUCCEEDED **`, no `Failing tests:`, zero retries).
