...
Three layers, 209 automated tests:
...
| App unit tests | 115 | persistence round-trips, corrupted-file quarantine, a frozen journal and its reload, legacy-record migration, in-progress snapshot validity, rest-day calendar math, Health export ordering and idempotence, the one-shot reminder window, day-anchor rollover, widget snapshot, the variation-debut badge, share-card wording and fit |
