...
Three layers, 644 automated tests: 70 core + 500 app units + 74 UI tests, all confirmed green on this wave's run (`** TEST SUCCEEDED **`, no `Failing tests:`, zero retries).
