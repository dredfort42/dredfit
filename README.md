...
runs 245 seconds — 255 when the rotation draws both of its unilateral moves,
each of which splits its slot in half with a counted pause to switch sides; the
