...
final class AppStoreTests: XCTestCase {
    ...
    // MARK: - Reminders (v1.6: injectable scheduler)

    private final class NotificationSpy: NotificationScheduling {
        var grant = true
        var scheduled: [(id: String, weekday: Int, hour: Int, minute: Int)] = []
        ...
        func addWeeklyReminder(id: String, title: String, body: String,
            ...
            scheduled.append((id, weekday, hour, minute))
        }
    }
    ...
    // MARK: - Live Activity staleDate (v1.6)
