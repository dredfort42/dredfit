...
final class EdgeCaseTests: XCTestCase {
    ...
    ///
    /// Re-marked: tier 1 runs 20-22-24-26-29-32-35-39,
    ...
    /// is what keeps the estimate monotone in the fact: clamping at
    ...
    func testDeloadTriggersViaOverrideDrop() {
        ...
        // The run-up is longer — "more" is worth two
        ...
        // Re-marked: the landing is no longer a flat
