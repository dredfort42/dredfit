...
//
//  golden.json is generated by make_golden.js from adaptive_engine.js (reference v2.0):
//  4 scenarios (always_plan, mixed, overrides, deload) with a full snapshot of every
//  session and the expected levels after each feedback step.
