...
jobs = [
    ...
    (f"{RAW}/howitworks_en.png", ["No black box"], "Nine plain facts about how the plan moves.", f"{OUT}/en/s8.png"),
    (f"{RAW}/howitworks_ru.png", ["Без черного ящика"], "Девять простых фактов о том, как движется план.", f"{OUT}/ru/s8.png"),
    (f"{RAW}/howitworks_es.png", ["Sin caja negra"], "Nueve datos simples sobre cómo se mueve el plan.", f"{OUT}/es/s8.png"),
    (f"{RAW}/howitworks_pt-br.png", ["Sem caixa-preta"], "Nove fatos simples sobre como o plano se move.", f"{OUT}/pt-br/s8.png"),
    (f"{RAW}/howitworks_de.png", ["Keine Blackbox"], "Neun einfache Fakten, wie sich der Plan bewegt.", f"{OUT}/de/s8.png"),
    (f"{RAW}/howitworks_fr.png", ["Pas de boîte noire"], "Neuf faits simples sur la façon dont le plan bouge.", f"{OUT}/fr/s8.png"),
    (f"{RAW}/howitworks_it.png", ["Nessuna scatola nera"], "Nove fatti semplici su come si muove il piano.", f"{OUT}/it/s8.png"),
